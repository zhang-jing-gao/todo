...
function useInjectionInstanceCollection(injectionName, collectionKey, registerKeyRef) {
    var _a;
    const injection = vue_1.inject(injectionName, null);
    if (injection === null)
        return;
    const vm = (_a = vue_1.getCurrentInstance()) === null || _a === void 0 ? void 0 : _a.proxy;
    vue_1.watch(registerKeyRef, registerInstance);
...
function useInjectionCollection(injectionName, collectionKey, valueRef) {
    ...
    vue_1.watch(valueRef, (value, prevValue) => {
...
function useDeferredTrue(valueRef, delay, shouldDelayRef) {
    if (!delay)
        return valueRef;
    const delayedRef = vue_1.ref(valueRef.value);
    let timerId = null;
    vue_1.watch(valueRef, (value) => {
        if (timerId !== null)
