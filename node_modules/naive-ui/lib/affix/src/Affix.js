...
exports.affixProps = {
    ...
    offsetTop: {
        ...
        validator: () => {
            if (process.env.NODE_ENV !== 'production') {
                _utils_1.warn('affix', '`offset-top` is deprecated, please use `trigger-top` instead.');
            }
            return true;
        },
        default: undefined
    ...
    offsetBottom: {
        ...
        validator: () => {
            if (process.env.NODE_ENV !== 'production') {
                _utils_1.warn('affix', '`offset-bottom` is deprecated, please use `trigger-bottom` instead.');
            }
            return true;
        },
        default: undefined
...
exports.default = vue_1.defineComponent({
    ...
    setup(props) {
        ...
        _mixins_1.useStyle('Affix', index_cssr_1.default, mergedClsPrefixRef);
        ...
        const init = () => {
            ...
            if (getScrollTarget) {
                ...
                scrollTarget = seemly_1.unwrapElement(listenTo);
            }
            else {
        ...
        function handleScroll() {
            seemly_1.beforeNextFrameOnce(_handleScroll);
        }
        function _handleScroll() {
            const { value: selfEl } = selfRef;
            if (!scrollTarget || !selfEl)
                return;
            const scrollTop = utils_1.getScrollTop(scrollTarget);
            if (affixedRef.value) {
            ...
            const containerRect = utils_1.getRect(scrollTarget);
