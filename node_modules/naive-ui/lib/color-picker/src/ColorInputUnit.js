...
exports.default = vue_1.defineComponent({
    ...
    setup(props) {
        ...
        const themeRef = vue_1.inject(ColorPicker_1.colorPickerThemeInjectionKey, null);
        vue_1.watchEffect(() => {
    ...
    render() {
        ...
        return (vue_1.h(input_1.NInput, { size: "small", placeholder: this.label, theme: mergedTheme.peers.Input, themeOverrides: mergedTheme.peerOverrides.Input, builtinThemeOverrides: inputThemeOverrides, value: this.inputValue, onUpdateValue: this.handleInputUpdateValue, onChange: this.handleInputChange, 
