...
exports.default = vue_1.defineComponent({
    ...
    render() {
        ...
        return (vue_1.h(popover_1.NPopover, { show: this.showPopover, onUpdateShow: (v) => (this.showPopover = v), trigger: "click", theme: mergedTheme.peers.Popover, themeOverrides: mergedTheme.peerOverrides.Popover, placement: "bottom", style: { padding: 0 } }, {
            trigger: () => {
