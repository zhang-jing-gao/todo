<template>
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M21 6.25C21 4.45507 19.5449 3 17.75 3H6.25C4.45507 3 3 4.45507 3 6.25V7H21V6.25Z" fill="currentColor" />
    <path d="M21 12.0218V8.5H3V17.75C3 19.5449 4.45507 21 6.25 21H12.0218C11.375 19.9897 11 18.7886 11 17.5C11 13.9101 13.9101 11 17.5 11C18.7886 11 19.9897 11.375 21 12.0218Z" fill="currentColor" />
