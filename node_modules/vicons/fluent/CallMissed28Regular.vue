<template>
  <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M14.5001 17.25C14.5001 16.8358 14.1643 16.5 13.7501 16.5C13.3358 16.5 13.0001 16.8358 13.0001 17.25V20.25C13.0001 20.6642 13.3358 21 13.7501 21H15.7501C16.1643 21 16.5001 20.6642 16.5001 20.25C16.5001 19.8358 16.1643 19.5 15.7501 19.5H14.5001V17.25Z" fill="currentColor" />
    <path d="M14.0001 26C17.5899 26 20.5001 23.0899 20.5001 19.5C20.5001 15.9101 17.5899 13 14.0001 13C10.4102 13 7.50006 15.9101 7.50006 19.5C7.50006 23.0899 10.4102 26 14.0001 26ZM14.0001 24.5C11.2386 24.5 9.00006 22.2614 9.00006 19.5C9.00006 16.7386 11.2386 14.5 14.0001 14.5C16.7615 14.5 19.0001 16.7386 19.0001 19.5C19.0001 22.2614 16.7615 24.5 14.0001 24.5Z" fill="currentColor" />
  </svg>
</template>
