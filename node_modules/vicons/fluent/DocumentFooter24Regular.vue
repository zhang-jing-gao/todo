<template>
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M7 15.75V17.25C7 18.2165 7.7835 19 8.75 19H15.25C16.2165 19 17 18.2165 17 17.25V15.75C17 14.7835 16.2165 14 15.25 14H8.75C7.7835 14 7 14.7835 7 15.75ZM8.75 15.5H15.25C15.3881 15.5 15.5 15.6119 15.5 15.75V17.25C15.5 17.3881 15.3881 17.5 15.25 17.5H8.75C8.61193 17.5 8.5 17.3881 8.5 17.25V15.75C8.5 15.6119 8.61193 15.5 8.75 15.5Z" fill="currentColor" />
  </svg>
</template>
