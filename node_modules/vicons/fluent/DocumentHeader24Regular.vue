<template>
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M7 6.75001C7 5.78351 7.7835 5.00001 8.75 5.00001H15.25C16.2165 5.00001 17 5.78351 17 6.75001V8.25001C17 9.2165 16.2165 10 15.25 10H8.75C7.7835 10 7 9.2165 7 8.25001V6.75001ZM8.75 6.50001C8.61193 6.50001 8.5 6.61193 8.5 6.75001V8.25001C8.5 8.38808 8.61193 8.50001 8.75 8.50001H15.25C15.3881 8.50001 15.5 8.38808 15.5 8.25001V6.75001C15.5 6.61193 15.3881 6.50001 15.25 6.50001H8.75Z" fill="currentColor" />
  </svg>
</template>
