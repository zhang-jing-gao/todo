<template>
  <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M8 5C6.89543 5 6 5.89543 6 7C6 8.10457 6.89543 9 8 9C9.10457 9 10 8.10457 10 7C10 5.89543 9.10457 5 8 5Z" fill="currentColor" />
    <path d="M5.6952 10C5.36398 10 5.00445 10.2376 4.97432 10.6569C4.9517 10.9715 4.97959 11.5787 5.43412 12.1095C5.89642 12.6495 6.70398 13 8 13C9.29602 13 10.1036 12.6495 10.5659 12.1095C11.0204 11.5787 11.0483 10.9715 11.0257 10.6569C10.9956 10.2376 10.636 10 10.3048 10H5.6952Z" fill="currentColor" />
