<template>
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M6.25 6.49999C5.00736 6.49999 4 7.50735 4 8.74999V15.25C4 16.4926 5.00736 17.5 6.25 17.5H12.75C13.9926 17.5 15 16.4926 15 15.25V8.74999C15 7.50735 13.9926 6.49999 12.75 6.49999H6.25Z" fill="currentColor" />
    <path d="M19.2699 16.3262L16 13.6013V10.4L19.2702 7.67818C19.4938 7.49207 19.8049 7.45206 20.0683 7.57554C20.3317 7.69902 20.5 7.96371 20.5 8.25464V15.75C20.5 16.041 20.3317 16.3057 20.0681 16.4292C19.8046 16.5526 19.4934 16.5125 19.2699 16.3262Z" fill="currentColor" />
  </svg>
</template>
