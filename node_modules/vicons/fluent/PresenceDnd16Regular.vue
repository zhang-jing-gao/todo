<template>
  <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.25 7C4.69772 7 4.25 7.44772 4.25 8C4.25 8.55228 4.69772 9 5.25 9H10.75C11.3023 9 11.75 8.55228 11.75 8C11.75 7.44772 11.3023 7 10.75 7H5.25Z" fill="currentColor" />
