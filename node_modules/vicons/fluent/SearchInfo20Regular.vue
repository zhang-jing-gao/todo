<template>
  <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M8.5 8C8.77614 8 9 8.22386 9 8.5V10.5C9 10.7761 8.77614 11 8.5 11C8.22386 11 8 10.7761 8 10.5V8.5C8 8.22386 8.22386 8 8.5 8Z" fill="currentColor" />
    <path d="M9 6.5C9 6.77614 8.77614 7 8.5 7C8.22386 7 8 6.77614 8 6.5C8 6.22386 8.22386 6 8.5 6C8.77614 6 9 6.22386 9 6.5Z" fill="currentColor" />
  </svg>
</template>
