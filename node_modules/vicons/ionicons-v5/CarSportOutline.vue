<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <rect x="400" y="384" width="56" height="16" style="fill: none; stroke: currentColor; stroke-linecap: round; stroke-linejoin: round; stroke-width: 32px" />
    <rect x="56" y="384" width="56" height="16" style="fill: none; stroke: currentColor; stroke-linecap: round; stroke-linejoin: round; stroke-width: 32px" />
    ...
    <line x1="432" y1="192" x2="448" y2="192" style="fill: none; stroke: currentColor; stroke-linecap: round; stroke-linejoin: round; stroke-width: 32px" />
    <line x1="64" y1="192" x2="80" y2="192" style="fill: none; stroke: currentColor; stroke-linecap: round; stroke-linejoin: round; stroke-width: 32px" />
    <path d="M78,211s46.35-12,178-12,178,12,178,12" style="fill: none; stroke: currentColor; stroke-linecap: round; stroke-linejoin: round; stroke-width: 32px" />
  </svg>
</template>
